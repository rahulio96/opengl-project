...
public class slCamera {
    ...
    private final float f_left = spot.FRUSTUM_LEFT;
    private final float f_right = spot.FRUSTUM_RIGHT;
    private final float f_bottom = spot.FRUSTUM_BOTTOM;
    private final float f_top = spot.FRUSTUM_TOP;
    private final float f_near = spot.Z_NEAR;
    private final float f_far = spot.Z_FAR;
