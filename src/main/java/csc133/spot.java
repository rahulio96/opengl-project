...
public class spot {
    ...
    public static final Vector3f ALIVE = new Vector3f(0.0f, 1.0f, 0.0f); // alive square color
    public static final Vector3f DEAD = new Vector3f(1.0f, 0.0f, 0.0f); // dead square color
